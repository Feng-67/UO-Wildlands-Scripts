...
{
    public class WaveSpawnTravesty : Item
    {
        ...
        // ---------------------------------------------------------------
        [Constructable]
        public WaveSpawnTravesty() : base(0xED4)
        {
            Name    = "Wave Spawn: Travesty";
            Movable = false;
            Visible = false;
            StartProximityTimer();
        }

        public WaveSpawnTravesty(Serial serial) : base(serial) { }
