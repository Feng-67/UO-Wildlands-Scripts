...
{
    public class WaveSpawnStygianDragon : Item
    {
        ...
        // ---------------------------------------------------------------
        [Constructable]
        public WaveSpawnStygianDragon() : base(0xED4)
        {
            Name    = "Wave Spawn: Stygian Dragon";
            Movable = false;
            Visible = false;
            StartProximityTimer();
        }

        public WaveSpawnStygianDragon(Serial serial) : base(serial) { }
        ...
        private void SpawnBoss()
        {
            ...
            Effects.PlaySound(Location, Map, 0x004);
            AddMobile(typeof(StygianDragon));
            StartCheckTimer();
        }
