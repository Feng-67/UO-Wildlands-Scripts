...
namespace Server.Mobiles
{
	public class XmlSpawnerDefaults
	{
		...
		public static DefaultEntry GetDefaults(string account, string name)
		{
			...
			_ = DefaultEntryList.Add(newentry);
			return newentry;
		}
	...
	public class XmlAddGump : Gump
	{
		...
		private string NameListToString()
		{
			...
			_ = sb.AppendFormat("{0}", defs.NameList.Length);
			for (var i = 0; i < defs.NameList.Length; i++)
			{
				_ = sb.AppendFormat(":{0}", defs.NameList[i]);
			}
			return sb.ToString();
		}
		...
		private string SelectionListToString()
		{
			...
			var sb = new System.Text.StringBuilder();
			_ = sb.AppendFormat("{0}", defs.SelectionList.Length);
			for (var i = 0; i < defs.SelectionList.Length; i++)
			{
				_ = sb.AppendFormat(":{0}", defs.SelectionList[i] ? 1 : 0);
			}
			return sb.ToString();
		}
		...
		private void DoSaveDefs(Mobile from, string filename)
		{
			...
			_ = ds.Tables.Add(DefsTablePointName);
			...
			_ = ds.Tables[DefsTablePointName].Columns.Add("MinDelay");
			_ = ds.Tables[DefsTablePointName].Columns.Add("MaxDelay");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SpawnRange");
			_ = ds.Tables[DefsTablePointName].Columns.Add("HomeRange");
			_ = ds.Tables[DefsTablePointName].Columns.Add("MinRefractory");
			_ = ds.Tables[DefsTablePointName].Columns.Add("MaxRefractory");
			_ = ds.Tables[DefsTablePointName].Columns.Add("TODStart");
			_ = ds.Tables[DefsTablePointName].Columns.Add("TODEnd");
			_ = ds.Tables[DefsTablePointName].Columns.Add("Duration");
			_ = ds.Tables[DefsTablePointName].Columns.Add("DespawnTime");
			_ = ds.Tables[DefsTablePointName].Columns.Add("RelativeHome");
			_ = ds.Tables[DefsTablePointName].Columns.Add("IsGroup");
			_ = ds.Tables[DefsTablePointName].Columns.Add("Team");
			_ = ds.Tables[DefsTablePointName].Columns.Add("ProximityTriggerSound");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SpeechTrigger");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SkillTrigger");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SequentialSpawn");
			_ = ds.Tables[DefsTablePointName].Columns.Add("ProximityRange");
			_ = ds.Tables[DefsTablePointName].Columns.Add("TODMode");
			_ = ds.Tables[DefsTablePointName].Columns.Add("KillReset");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SpawnerName");
			_ = ds.Tables[DefsTablePointName].Columns.Add("AllowGhost");
			_ = ds.Tables[DefsTablePointName].Columns.Add("AllowNPC");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SpawnOnTrigger");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SmartSpawn");
			_ = ds.Tables[DefsTablePointName].Columns.Add("ExtTrig");
			_ = ds.Tables[DefsTablePointName].Columns.Add("TrigOnCarried");
			_ = ds.Tables[DefsTablePointName].Columns.Add("NoTrigOnCarried");
			_ = ds.Tables[DefsTablePointName].Columns.Add("ProximityMessage");
			_ = ds.Tables[DefsTablePointName].Columns.Add("TrigProb");
			_ = ds.Tables[DefsTablePointName].Columns.Add("PlayerTrigProp");
			_ = ds.Tables[DefsTablePointName].Columns.Add("TrigObjectProp");
			//ds.Tables[DefsTablePointName].Columns.Add( "DefsExt" );
			_ = ds.Tables[DefsTablePointName].Columns.Add("NameList");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SelectionList");
			_ = ds.Tables[DefsTablePointName].Columns.Add("AddGumpX");
			_ = ds.Tables[DefsTablePointName].Columns.Add("AddGumpY");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SpawnerGumpX");
			_ = ds.Tables[DefsTablePointName].Columns.Add("SpawnerGumpY");
			_ = ds.Tables[DefsTablePointName].Columns.Add("FindGumpX");
			_ = ds.Tables[DefsTablePointName].Columns.Add("FindGumpY");
			_ = ds.Tables[DefsTablePointName].Columns.Add("AutoNumber");
			_ = ds.Tables[DefsTablePointName].Columns.Add("AutoNumberValue");
			...
			if (File.Exists(dirname))
			{
				...
				if (ds.Tables.Count > 0)
				{
					...
					if (ds.Tables[DefsTablePointName] != null && ds.Tables[DefsTablePointName].Rows.Count > 0)
					{
						...
						try { defs.SpawnRange = Int32.Parse((string)dr["SpawnRange"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.HomeRange = Int32.Parse((string)dr["HomeRange"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.HomeRangeIsRelative = Boolean.Parse((string)dr["RelativeHome"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.Group = Boolean.Parse((string)dr["IsGroup"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.Team = Int32.Parse((string)dr["Team"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						...
						try { defs.ProximityRange = Int32.Parse((string)dr["ProximityRange"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.ProximitySound = Int32.Parse((string)dr["ProximityTriggerSound"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						...
						try { defs.SequentialSpawn = Int32.Parse((string)dr["SequentialSpawn"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.KillReset = Int32.Parse((string)dr["KillReset"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.TriggerProbability = Double.Parse((string)dr["TrigProb"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.AllowGhostTrig = Boolean.Parse((string)dr["AllowGhost"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.AllowNPCTrig = Boolean.Parse((string)dr["AllowNPC"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.SpawnOnTrigger = Boolean.Parse((string)dr["SpawnOnTrigger"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.SmartSpawning = Boolean.Parse((string)dr["SmartSpawn"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.ExternalTriggering = Boolean.Parse((string)dr["ExtTrig"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						...
						try { defs.AddGumpX = Int32.Parse((string)dr["AddGumpX"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.AddGumpY = Int32.Parse((string)dr["AddGumpY"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.SpawnerGumpX = Int32.Parse((string)dr["SpawnerGumpX"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.SpawnerGumpY = Int32.Parse((string)dr["SpawnerGumpY"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.FindGumpX = Int32.Parse((string)dr["FindGumpX"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.FindGumpY = Int32.Parse((string)dr["FindGumpY"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.AutoNumber = Boolean.Parse((string)dr["AutoNumber"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
						try { defs.AutoNumberValue = Int32.Parse((string)dr["AutoNumberValue"]); }
						catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
		...
		public static void XmlAdd_OnCommand(CommandEventArgs e)
		{
			...
			_ = e.Mobile.SendGump(new XmlAddGump(e.Mobile, e.Mobile.Location, e.Mobile.Map, true, false, x, y));
		...
		private void DoShowProps(IEntity x)
		{
			...
			_ = m_From.SendGump(new PropertiesGump(m_From, x));
		}
		...
		public static void Refresh(Mobile from, bool ignoreupdate)
		{
			...
			_ = from.CloseGump(typeof(XmlAddGump));

			defs.IgnoreUpdate = false;
			_ = from.SendGump(new XmlAddGump(from, defs.StartingLoc, defs.StartingMap, false, defs.ShowExtension, x, y));
		}
		...
		public override void OnResponse(NetState state, RelayInfo info)
		{
			...
			if (tr?.Text != null && tr.Text.Length > 0)
			{
				try { defaults.HomeRange = Int32.Parse(tr.Text); }
				catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
			}
			...
			if (tr?.Text != null && tr.Text.Length > 0)
			{
				try { defaults.SpawnRange = Int32.Parse(tr.Text); }
				catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
			}
			...
			if (tr?.Text != null && tr.Text.Length > 0)
			{
				try { defaults.ProximityRange = Int32.Parse(tr.Text); }
				catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
			}
			...
			if (tr?.Text != null && tr.Text.Length > 0)
			{
				try { defaults.Team = Int32.Parse(tr.Text); }
				catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
			}
			...
			if (tr?.Text != null && tr.Text.Length > 0)
			{
				try { defaults.ProximitySound = Int32.Parse(tr.Text); }
				catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
			}
			...
			if (tr?.Text != null && tr.Text.Length > 0)
			{
				try { defaults.KillReset = Int32.Parse(tr.Text); }
				catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
			}
			...
			if (tr?.Text != null && tr.Text.Length > 0)
			{
				try { defaults.AutoNumberValue = Int32.Parse(tr.Text); }
				catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
			}
			...
			switch (info.ButtonID)
			{
				...
				case 156: // Delete last spawner
				{
					...
					_ = state.Mobile.SendGump(new XmlAddConfirmDeleteGump(defaults.LastSpawner));
					return;
				}
				...
				{
					Refresh(state.Mobile);
					_ = state.Mobile.SendGump(new XmlAddOptionsGump(state.Mobile));
					return;
				}
				...
				default:
				{
					...
					if (info.ButtonID >= 5000 && info.ButtonID < 5000 + MaxEntries)
					{
						...
						if (defaults.NameList[i] == null || defaults.NameList[i].Length == 0)
						{
							...
							_ = state.Mobile.CloseGump(typeof(XmlCategorizedAddGump));
							_ = state.Mobile.SendGump(new XmlCategorizedAddGump(state.Mobile, defaults.CurrentCategory, defaults.CurrentCategoryPage, i, newg));
						}
						else
						{
							// use the XmlPartialCategorizedAddGump
							_ = state.Mobile.CloseGump(typeof(XmlPartialCategorizedAddGump));
							...
							_ = state.Mobile.SendGump(new XmlPartialCategorizedAddGump(state.Mobile, defaults.NameList[i], 0, types, true, i, newg));
						}
		...
		private class XmlAddOptionsGump : Gump
		{
			...
			public override void OnResponse(NetState state, RelayInfo info)
			{
				...
				if (tr?.Text != null && tr.Text.Length > 0)
				{
					try { defs.AddGumpX = Int32.Parse(tr.Text); }
					catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
				}
				tr = info.GetTextEntry(101);        // AddGumpY info
				if (tr?.Text != null && tr.Text.Length > 0)
				{
					try { defs.AddGumpY = Int32.Parse(tr.Text); }
					catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
				}
				tr = info.GetTextEntry(102);        // SpawnerGumpX info
				if (tr?.Text != null && tr.Text.Length > 0)
				{
					try { defs.SpawnerGumpX = Int32.Parse(tr.Text); }
					catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
				}
				tr = info.GetTextEntry(103);        // SpawnerGumpY info
				if (tr?.Text != null && tr.Text.Length > 0)
				{
					try { defs.SpawnerGumpY = Int32.Parse(tr.Text); }
					catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
				}
				tr = info.GetTextEntry(104);        // FindGumpX info
				if (tr?.Text != null && tr.Text.Length > 0)
				{
					try { defs.FindGumpX = Int32.Parse(tr.Text); }
					catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
				}
				tr = info.GetTextEntry(105);        // FindGumpY info
				if (tr?.Text != null && tr.Text.Length > 0)
				{
					try { defs.FindGumpY = Int32.Parse(tr.Text); }
					catch (Exception e) { Diagnostics.ExceptionLogging.LogException(e); }
				}
			}
		}
