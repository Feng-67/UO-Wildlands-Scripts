...
{
    public class WaveSpawnMedusa: Item
    {
        ...
        // ---------------------------------------------------------------
        [Constructable]
        public WaveSpawnMedusa() : base(0xED4)
        {
            Name    = "Wave Spawn: Medusa";
            Movable = false;
            Visible = false;
            StartProximityTimer();
        }

        public WaveSpawnMedusa(Serial serial) : base(serial) { }
