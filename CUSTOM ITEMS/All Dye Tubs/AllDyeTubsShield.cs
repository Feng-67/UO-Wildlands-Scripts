...
{
	public class AllDyeTubsShield : DyeTub
	{
...
//		private int TheHue = AllHuesInfo.Reds;
		...
		[Constructable]
		public AllDyeTubsShield(  )
		{
			Name = "Dye Tub [All Shields]";
			Weight = 5.0;
			Hue = TheHue;
			DyedHue = TheHue;
			Charges = 5;
		...
		public void DoOut ( Mobile from )
		{
			if ( from.InRange( this.GetWorldLocation(), 1 ) )
			{
				...
				from.Target = new AllDyeTubsShieldTarget( this );
			}
			else
			{
		...
		public AllDyeTubsShield( Serial serial ) : base( serial ){}
		...
		public class AllDyeTubsShieldTarget : Target
		{
			private AllDyeTubsShield m_Tub;

			public AllDyeTubsShieldTarget( AllDyeTubsShield dyetub ) : base( 12, false, TargetFlags.None )
			{
				m_Tub = dyetub;
			}
