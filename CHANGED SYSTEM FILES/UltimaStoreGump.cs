...
namespace Server.Engines.UOStore
{
    public class UltimaStoreGump : BaseGump
    {
        ...
        public override void AddGumpLayout()
        {
            ...
            // --- RE-ARRANGED CATEGORY BUTTONS (Featured Removed) ---
            ...
            // --- REMOVED SECTIONS ---
            // Featured, Promo Code, FAQ, and Sort By buttons have been removed from here.
        ...
        public override void OnResponse(RelayInfo info)
        {
            ...
            {
                // Change Category
                // Note: ID 100 (Featured) is removed from UI but leaving case here is harmless
                case 100:
                case 101:
                case 102:
                case 103:
