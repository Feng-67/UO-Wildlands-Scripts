...
{
    public class WaveSpawnMonstrousInterredGrizzle : Item
    {
        ...
        // ---------------------------------------------------------------
        [Constructable]
        public WaveSpawnMonstrousInterredGrizzle() : base(0xED4)
        {
            Name    = "Wave Spawn: Monstrous Interred Grizzle";
            Movable = false;
            Visible = false;
            StartProximityTimer();
        }

        public WaveSpawnMonstrousInterredGrizzle(Serial serial) : base(serial) { }
        ...
        private void SpawnBoss()
        {
            ...
            Effects.PlaySound(Location, Map, 0x100);
            AddMobile(typeof(MonstrousInterredGrizzle));
            StartCheckTimer();
        }
