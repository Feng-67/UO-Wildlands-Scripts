...
namespace Server.Mobiles
{
    ...
    public class RideableDragon : BaseMount
    {
        [Constructable]
        public RideableDragon()
            : base("a rideable dragon", 0xC, 0x3ECE, AIType.AI_Mage, FightMode.Evil, 10, 1, 0.2, 0.4)
        {
            Name = "a rideable dragon";
            Body = 103;
            Hue = 1908;
        ...
        public RideableDragon(Serial serial)
            : base(serial)
        {
        }
