...
{
    [CorpseName("a corpse")]
    public class AlaskanMalamute : BaseMount
    {
        ...
        [Constructable]
        public AlaskanMalamute(string name) : base(name, 0xE2, 0x3EA0, AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4)
        {
        ...
        public AlaskanMalamute(Serial serial)
            : base(serial)
        {
        }
