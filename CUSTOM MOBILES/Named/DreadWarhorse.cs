...
namespace Server.Mobiles
{
    ...
    public class DreadWarhorse : BaseMount
    {
        ...
        private static readonly SpecialAbility[] _DreadWarhorseAbilities =
{
        ...
        public override TrainingDefinition TrainingDefinition
        {
            get
            {
                return new TrainingDefinition(
                    ...
                    Class.Magical | Class.Necromantic,
                    MagicalAbility.Chivalry | MagicalAbility.Discordance | MagicalAbility.MageryMastery |
                    MagicalAbility.Mysticism | MagicalAbility.Necromage | MagicalAbility.Necromancy |
                    MagicalAbility.Poisoning | MagicalAbility.Spellweaving | MagicalAbility.BattleDefense |
                    MagicalAbility.Bashing | MagicalAbility.Piercing | MagicalAbility.Slashing |
                    MagicalAbility.WrestlingMastery,
                    _DreadWarhorseAbilities,
