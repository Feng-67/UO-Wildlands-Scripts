 ...
 *
 * Wave Spawner: Skeletal Horse
 * Four waves centred on the spawner item within a 10-tile radius.
 * Place with [add WaveSpawnSkeletalHorse, then GM double-click to start.
 * 1-hour cooldown after SkeletalHorse is tamed or killed.
 */
...
{
    public class WaveSpawnSkeletalHorse : Item
    {
        ...
        // ---------------------------------------------------------------
        [Constructable]
        public WaveSpawnSkeletalHorse() : base(0xED4)
        {
        ...
        private void SpawnBoss()
        {
            ...
            Effects.PlaySound(Location, Map, 0x009);
            AddMobile(typeof(SkeletalHorse));
            StartCheckTimer();
        }
