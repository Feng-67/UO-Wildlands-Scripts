    ...
    public class RisingColossusSpell : MysticSpell
    {
        ...
        public void Target(IPoint3D p)
        {
            ...
            else if (SpellHelper.CheckTown(p, Caster) && CheckSequence())
            {
                ...
                // This flag (true) combined with AIType.AI_Melee makes it commandable
                BaseCreature.Summon(summon, true, Caster, new Point3D(p), 0x656, duration);
