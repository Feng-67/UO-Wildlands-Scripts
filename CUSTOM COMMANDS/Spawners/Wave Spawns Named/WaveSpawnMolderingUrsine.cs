 ...
 *
 * Wave Spawner: MolderingUrsine
 * Four waves centred on the spawner item within a 10-tile radius.
 * Place with [add WaveSpawnMolderingUrsine, then GM double-click to start.
 * 1-hour cooldown after MolderingUrsine is tamed or killed.
 */
...
{
    public class WaveSpawnMolderingUrsine : Item
    {
        ...
        private static Type[][] BuildWaves()
        {
            return new Type[][]
            {
                // Wave 1
                BuildWave(
                    (typeof(RagingGrizzlyBear), 20)),

                // Wave 2
                BuildWave(
                    (typeof(RevenantLion), 5)),
        ...
        // ---------------------------------------------------------------
        [Constructable]
        public WaveSpawnMolderingUrsine() : base(0xED4)
        {
        ...
        private void SpawnBoss()
        {
            ...
            Effects.PlaySound(Location, Map, 0x009);
            AddMobile(typeof(MolderingUrsine));
            StartCheckTimer();
        }
