...
{
    public class WaveSpawnChiefParoxysmus: Item
    {
        ...
        // ---------------------------------------------------------------
        [Constructable]
        public WaveSpawnChiefParoxysmus() : base(0xED4)
        {
            Name    = "Wave Spawn: Chief Paroxysmus";
            Movable = false;
            Visible = false;
            StartProximityTimer();
        }

        public WaveSpawnChiefParoxysmus(Serial serial) : base(serial) { }
        ...
        private void SpawnBoss()
        {
            ...
            Effects.PlaySound(Location, Map, 0x166);
            AddMobile(typeof(ChiefParoxysmus));
            StartCheckTimer();
        }
