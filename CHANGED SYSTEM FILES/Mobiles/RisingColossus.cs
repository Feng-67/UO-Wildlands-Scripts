...
namespace Server.Mobiles
{
    public class RisingColossus : BaseCreature
    {
        ...
        public RisingColossus(Mobile m, double baseskill, double boostskill)
            // CHANGE 1: AI_Mystic -> AI_Melee so it obeys commands
            : base(AIType.AI_Melee, FightMode.Closest, 10, 1, 0.4, 0.5) 
        {
            ...
            // Added null checks just in case caster is missing skills
            if (m != null)
            {
        ...
        // Removing this allows the AI to respect "All Kill" / "All Follow" orders.
